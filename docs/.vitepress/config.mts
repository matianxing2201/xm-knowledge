  ...
  withFolderTree(
    defineConfig({
      ...
      vite: {
        ...
        optimizeDeps: {
          // Mermaid 是从插件的绝对路径加载的，显式声明其 CommonJS 子依赖
          include: [
            "mermaid",
          ...
          "/web/react/核心概念/": [
            {
              ...
              items: [
                {
                  text: "初识React",
                  link: "/web/react/核心概念/intro-to-react",
                },
                {
                ...
                {
                  text: "列表渲染",
                  link: "/web/react/核心概念/list-rendering",
                },
                {
                  text: "条件渲染",
          ...
          "/web/react/高级指引/": [
            {
              ...
              items: [
                ...
                {
                  text: "Context API",
                  link: "/web/react/高级指引/context-api",
                },
                {
...
// Mermaid 的 dayjs 导入不能直接落到 CJS 的 dayjs.min.js；使用精确匹配，
// 避免影响 dayjs/plugin/* 的路径别名。
const aliases = config.vite?.resolve?.alias;
